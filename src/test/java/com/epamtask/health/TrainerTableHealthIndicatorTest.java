...
class TrainerTableHealthIndicatorTest {

    private TrainerTableHealthIndicator indicator;
    ...
    void setUp() throws Exception {
        ...
        indicator = new TrainerTableHealthIndicator(dataSource);
    }
    ...
    void shouldReturnHealthUpWhenCountPositive() {
        ...
        assertThat(health.getDetails().values()).contains(4);
    }
    ...
    void shouldReturnHealthDownOnException() throws Exception {
        ...
        Health health = new TrainerTableHealthIndicator(errorDs).health();
