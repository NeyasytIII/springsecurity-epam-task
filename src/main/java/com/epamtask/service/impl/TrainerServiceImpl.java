...
public class TrainerServiceImpl implements TrainerService {
    ...
    public void createTrainer(String firstName, String lastName, String specialization) {
        ...
        TrainingTypeEntity specializationType = trainingTypeService
                ...
                .orElseThrow(() -> new IllegalArgumentException("Unknown specialization type: " + specialization));
    ...
    public void updateTrainer(Trainer trainer) {
        ...
        if (trainer.getSpecialization() != null) {
            TrainingTypeEntity typeEntity = trainingTypeService
                    .getTrainingTypeByName(trainer.getSpecialization())
                    .orElseThrow(() -> new IllegalArgumentException("Unknown specialization type: " + trainer.getSpecialization()));
            trainer.setSpecializationType(typeEntity);
        }
        trainerStorage.save(trainer);
    }
